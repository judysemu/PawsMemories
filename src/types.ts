export enum Screen {
  ...
  LANDING_CATS = "LANDING_CATS",
  LANDING_PROFESSIONALS = "LANDING_PROFESSIONALS",
  LANDING_GLB_GUIDE = "LANDING_GLB_GUIDE",
  LANDING_DENVER = "LANDING_DENVER",
  LANDING_PHILADELPHIA = "LANDING_PHILADELPHIA",
